...
var tasks = {
    ...
    'sourcemod-update': ['sourcemod-build', 'srcds-link', function() {
        ...
        return Promise.all([
                ...
                helpers.mirror('SM enabled plugin update', path.join(path.resolve(argv.sourcemod), 'build', 'package', 'addons', 'sourcemod', 'plugins'), path.join(serverPath, 'tf', 'addons', 'sourcemod', 'plugins'), false, true),
                helpers.mirror('SM currently enabled plugin update', path.join(path.resolve(argv.sourcemod), 'build', 'package', 'addons', 'sourcemod', 'plugins', 'disabled'), path.join(serverPath, 'tf', 'addons', 'sourcemod', 'plugins'), false, true),
                helpers.mirror('SM currently disabled plugin update', path.join(path.resolve(argv.sourcemod), 'build', 'package', 'addons', 'sourcemod', 'plugins'), path.join(serverPath, 'tf', 'addons', 'sourcemod', 'plugins', 'disabled'), false, true),
                helpers.mirror('SM disabled plugin update', path.join(path.resolve(argv.sourcemod), 'build', 'package', 'addons', 'sourcemod', 'plugins', 'disabled'), path.join(serverPath, 'tf', 'addons', 'sourcemod', 'plugins', 'disabled'), false, true),
